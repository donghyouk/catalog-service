...
@DataJdbcTest
@Import(DataConfig.class) // auditing
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) // 테스트 컨테이너를 이용하기 때문에 내장 테스트 데이터베이스를 비활성화
                                                                             // 한다.
...
public class BookRepositoryJdbcTests {
    ...
    @Autowired
    private JdbcAggregateTemplate jdbcAggregateTemplate; // 데이터베이스와 상화 작용하기 위한 하위 수준의 객체
    ...
    void existsByIsbnWhenNotExisting() {
        boolean existing = bookRepository.existsByIsbn("12345612340");
